...
const (
	...
	// LEADER_COMMITTED_INDEX_REQUEST is used to serve clients' read-only queries without
	...
	MESSAGE_TYPE_LEADER_COMMITTED_INDEX_REQUEST MESSAGE_TYPE = 15
	// LEADER_COMMITTED_INDEX_RESPONSE is response to LEADER_COMMITTED_INDEX_REQUEST.
	//
	// (Raft 6.4 Processing read-only queries more efficiently, page 72)
	// (etcd: raft.raftpb.MsgReadIndexResp)
	MESSAGE_TYPE_LEADER_COMMITTED_INDEX_RESPONSE MESSAGE_TYPE = 16
)
...
var MESSAGE_TYPE_name = map[int32]string{
	...
	15: "LEADER_COMMITTED_INDEX_REQUEST",
	16: "LEADER_COMMITTED_INDEX_RESPONSE",
}
var MESSAGE_TYPE_value = map[string]int32{
	...
	"LEADER_COMMITTED_INDEX_REQUEST":  15,
	"LEADER_COMMITTED_INDEX_RESPONSE": 16,
}
...
var fileDescriptorRaftpb = []byte{
	...
	,
}
