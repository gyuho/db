...
func TestIDString(t *testing.T) {
	...
	for i, tt := range tests {
		got := tt.input.String()
		if tt.want != got {
			t.Fatalf("#%d: ID.String expected %v, got %v", i, tt.want, got)
		}
	}
}
...
func TestIDFromString(t *testing.T) {
	...
	for i, tt := range tests {
		...
		if err != nil {
			t.Fatalf("#%d: IDFromString %v", i, err)
			continue
		}
		if tt.want != got {
			t.Fatalf("#%d: IDFromString expected %v, got %v", i, tt.want, got)
		}
	}
}
...
func TestIDFromStringFail(t *testing.T) {
	...
	for i, tt := range tests {
		...
		if err == nil {
			t.Fatalf("#%d: IDFromString expected error, got err=nil", i)
		}
	}
}
